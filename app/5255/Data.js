    ...
    <div className={styles.main}>
      ...
      <div className={styles.center}>
        <div className={styles.sectionSmall}>
          ...
          <div>
The Lexmark XC 5255 is a perfect choice for hospitals. Its fast printing and scanning speeds ensure quick processing of crucial documents, supporting efficient workflow management. Advanced security features protect sensitive medical information in compliance with regulations like HIPAA. The intuitive touchscreen interface and customizable workflows simplify document management, reducing administrative tasks. Its compact design and quiet operation make it suitable for busy hospital environments. Overall, the Lexmark XC 5255 enhances productivity and confidentiality in hospital document management.</div>
        </div>
      </div>
      <div className={styles.center}>
