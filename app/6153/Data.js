    ...
    <div className={styles.main}>
      ...
      <div className={styles.center}>
        <div className={styles.sectionSmall}>
          ...
          <div>
The Lexmark XC 6153 is an excellent choice for hospitals because it's fast, secure, and user-friendly. Its quick printing and scanning capabilities help healthcare staff process important documents like patient records efficiently. Advanced security features protect sensitive medical information, ensuring compliance with regulations like HIPAA. The touchscreen interface and customizable workflows simplify document management tasks, reducing administrative work. Plus, its compact design and quiet operation make it perfect for busy hospital environments. Overall, the Lexmark XC 6153 improves productivity and confidentiality in hospital document management.</div>
        </div>
      </div>
      <div className={styles.center}>
