    ...
    <div className={styles.main}>
      ...
      <div className={styles.center}>
        <div className={styles.sectionSmall}>
          ...
          <div>
The Lexmark XC 9335 is an excellent choice for hospitals. Its fast printing and scanning speeds ensure efficient document processing, while advanced security features protect patient information. The intuitive interface and customizable workflows streamline document management, reducing administrative tasks. Its durable design makes it ideal for continuous use in busy hospital environments. Overall, the Lexmark XC 9335 enhances productivity and confidentiality in hospital document management.</div>
        </div>
      </div>
      <div className={styles.center}>
